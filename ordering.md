...
Existing `SoftLayer` customers can log in to [https://control.softlayer.com/ ![External link icon](../../icons/launch-glyph.svg "External link icon")](https://control.softlayer.com/){:new_window}, but are encouraged to create an IBMid and explore the {{site.data.keyword.Bluemix}} catalog. Both control portals are equivalent in functionality and differ only in their header design and branding.
1. Log in to [https://control.bluemix.net/](https://control.bluemix.net/ ![External link icon](../../icons/launch-glyph.svg "External link icon")){: new_window}.
