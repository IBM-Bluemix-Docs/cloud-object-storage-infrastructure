...
You can archive rarely accessed data. Archive works with existing storage-class tiers, enabling you to reduce storage costs even further by storing data offline with our lowest-priced storage. See [Archiving objects](archiving.html#archiving-objects) for more information.
{:tip}
