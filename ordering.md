...
Cloud Object Storage archiving is included with your storage account. Archive works with existing storage-class tiers, enabling you to reduce storage costs even further by storing data offline with our lowest-priced storage. You will not be charged for archiving unless you use it. See [Archiving objects](archiving.html#archiving-objects) for more information.
{:tip}
